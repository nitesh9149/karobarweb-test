          ...
          <div class="level-item">
            <div v-if="globalHelper('createExpense')" class="buttons is-right">
              ...
              >
                ...
                <span class="button-title">Add New Income</span>
              </button>
    ...
    <section v-if="!posts.length">
      ...
      <template v-else>
        <div class="emptyPage">
          ...
          <p>Record your business incomes</p>
        </div>
      </template>
    </section>
  </div>
...
export default {
  ...
  methods: {
    ...
    async trashConfirm(post, category) {
      const loadingComponent = this.$buefy.loading.open();
      this.isModalActive = false;
    ...
    async confirmAdd(post, category) {
      const loadingComponent = this.$buefy.loading.open();
      this.isModalActive = false;
      this.expensePost = post;
      try {
