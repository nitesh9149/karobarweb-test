...
export default {
      ...
      if (this.sale.party_name == "") {
        ...
        if (this.totalSum >= 0) {
          ...
          try {
            ...
            this.$buefy.snackbar.open({
              message: "Purchase Invoice has been created",
              type: "is-primary",
              position: "is-bottom",
              indefinite: false,
            });
            localStorage.setItem("purchase", response.data.purchase.id);
  ...
  head() {
    return {
      title: "Create Purchase Invoice - Karobar",
    };
  },
};
</script>
