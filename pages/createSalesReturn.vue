...
export default {
      ...
      if (this.sale.party_name == "") {
        ...
        if (this.totalSum >= 0) {
          ...
          try {
            ...
            this.$buefy.snackbar.open({
              message: "Sales Return has been created",
              type: "is-primary",
              position: "is-bottom",
              indefinite: false,
            });
            localStorage.setItem("sales_return", response.data.sale_return.id);
  ...
  head() {
    return {
      title: "Create Sales Return Invoice - Karobar",
    };
  },
};
</script>
