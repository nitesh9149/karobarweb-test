    ...
    <section class="section is-main-section">
      <div class="items-excel-content">
        <div class="excel-sample">
          <p>
            Import products in bulk from an excel file. Note that your file
          ...
          <figure>
            ...
            <img src="@/img/sample1.png" alt="Excel Sample" />
          </figure>
          <a
            href="/Karobar_Products_Import_Sample.xlsx"
            download
            target="_blank"
  ...
  methods: {
    async save(event) {
      ...
      try {
        ...
        let response = await axios.post("/core/import-products/", formData, {
          headers: {
