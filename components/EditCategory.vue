        ...
        <div class="modal-form">
          <div class="columns">
            <div class="column is-12">
              ...
              <div v-if="$v.post.name.$error" class="form-error">
    ...
    async confirm() {
      if (!this.$v.$invalid) {
        try {
          ...
          category.name = this.post.name.trim();
          category.business = localStorage.getItem("business");
          category.user = this.$auth.user.id;
          const response = await axios.put("/inventory/categories/" + this.post.id + "/?business=" + localStorage.getItem("business"), category, {
            headers: {
