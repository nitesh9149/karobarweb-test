        ...
        <div class="modal-form">
          <div class="columns">
            <div class="column is-12">
              <b-field label="Write Terms &amp; Condtion below">
                <b-input v-model="terms.terms_conditions" type="textarea" placeholder="Write Here"></b-input>
              </b-field>
            </div>
          </div>
        </div>
...
export default {
  ...
  async mounted(){
    try{
      ...
      this.terms.terms_conditions = response.data.terms_conditions
      }
      catch(err){
      };
  },
  methods: {
    ...
    async confirm() {
      ...
      this.$buefy.snackbar.open({
        message: "Terms & Conditions has been set",
        type: "is-primary",
        position: "is-bottom",
        indefinite: false,
      });
