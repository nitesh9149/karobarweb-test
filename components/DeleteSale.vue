<template>
  <b-modal
    class="bank-balance-reduce-modal"
    data:posts
  ...
  >
    <div class="modal-card">
      <header class="modal-card-head">
        <p class="modal-card-title">DELETE {{title.toUpperCase()}} ?</p>
      ...
      <section class="modal-card-body">
        <div class="modal-form">
            You are about to delete {{title}}. Please Note that this will
            delete all the data related to it .
        </div>
      </section>
      <footer class="modal-card-foot">
        <div class="buttons">
          <b-button @click="cancel" type="is-light">CANCEL </b-button>
          <b-button @click="confirm" type="is-primary">DELETE</b-button>
        </div>
      </footer>
    </div>
  </b-modal>
...
export default {
  ...
  data() {
    return {
      ...
      currentType: { text: "Customer" },
      types: [{ text: "Customer" }, { text: "Supplier" }],
      currentVat: { text: "PAN" },
...
.bank-balance-reduce-modal {
  ...
  .datepicker .control.has-icons-right .icon {
    color: $red;
    top: 3px;
  }
  .datepicker {
  ...
  .datepicker .control.has-icons-left .input:focus ~ .icon,
  .datepicker
