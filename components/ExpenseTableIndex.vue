  ...
  <div>
    ...
    >
      <template slot-scope="props">
        ...
        <b-table-column class="pad_left" label="Transaction Id" field="id">
          {{ props.row.number }}
        </b-table-column>
        <b-table-column class="pad_left" label="Party Name" field="party">
...
export default {
  ...
  async mounted() {
    ...
    response.data.recent_transactions.forEach((element) => {
      var date1 =
