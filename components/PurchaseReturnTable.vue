  ...
  <div>
    ...
    >
      <template slot-scope="props">
        <b-table-column class="pad_left" label="Party Name" field="name">
          {{ props.row.party_value }}
        </b-table-column>
        <b-table-column class="pad_left" label="Invoice No." field="sale">
          {{ props.row.number }}
        </b-table-column>
        ...
        <b-table-column class="pad_left" label="Due Date" field="Date">
          <span v-if="props.row.due">
            {{ props.row.nep_due }}
          </span>
          <span v-else>-</span>
        </b-table-column>
        <b-table-column class="pad_left" field="status" label="Status">
          <div
            class="status"
            :class="
        ...
        <b-table-column class="pad_left" label="Unpaid Amount" field="balance">
...
export default {
  ...
  async mounted() {
    ...
    let response = await axios.get(
      "/transactions/purchase-return/?business=" +
  ...
  methods: {
    clickRow(event) {
      localStorage.setItem("purchase_return", event.id);
